...
mysqli_query($connection,"insert into products (product_name, details, image, price, c_price, product_type, brand, tags) values ('$product_name','$details','$pic_name','$price','$c_price','$product_type','$brand','$tags')") or die ("query incorrect");
 $pid=-1;
$res = mysqli_query($connection,"select product_id from products where product_name ='$product_name' AND details ='$details' AND image ='$pic_name' LIMIT 1")or die("Query 1 is inncorrect..........");
if ($res->num_rows > 0) {
    $row = $res->fetch_assoc();
	$pid= $row["product_id"];
 ...
 //echo "product_id: " . $pid;
 mysqli_query($connection,"insert into inventory_manage (product_id, product_name, curr_quantity, min_quantity) values ('$pid','$product_name','$curr_quantity','$min_quantity')") or die ("query incorrect");
...
<h3>Category</h3>  
<p>Product type</p>
<input type="text" name="product_type" id="product_type" class="form-control" placeholder="Tablet / Syrups / Equip">
<br>
<p>Vendor / Brand</p>
<input type="text" name="brand" id="brand" class="form-control" placeholder="Abbott , Bayer">
<br>
<p>Other tags</p>
<input type="text" name="tags" id="tags" class="form-control" placeholder="tablets medicines syrups">
<p>Current Quantity</p>
<input type="text" name="curr_quantity" id="curr_quantity" class="form-control" placeholder="500">
<p>Minimum Quantity</p>
<input type="text" name="min_quantity" id="min_quantity" class="form-control" placeholder="100">
</div>          
</div>

<div align="center">
    <button type="submit" name="" id="" class="btn btn-default" style="width:100px; height:60px"> Cancel</button>
